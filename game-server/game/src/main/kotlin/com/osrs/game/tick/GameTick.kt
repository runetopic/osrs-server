...
class GameTick(
    ...
    override fun run() {
        ...
        try {
            ...
            logger.info { "Game Tick #$tick took $time ms. Players=${world.players.size} Npcs=${world.npcs.size} Memory=(Max: $maxMemoryMB MB Allocated: $allocatedMemoryMB MB Free: $freeMemory MB Used: $usedPercentage%)" }
