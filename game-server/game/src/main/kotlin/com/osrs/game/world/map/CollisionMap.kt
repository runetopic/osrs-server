...
//    val zones: Zones,
//    val collisionFlagMap: CollisionFlagMap
//) {
//    fun applyCollision(entry: MapSquareEntry) {
//        for (level in 0 until LEVELS) {
//            for (x in 0 until MAP_SIZE) {
//                for (z in 0 until MAP_SIZE) {
//                    if ((entry.terrain[level][x][z]!!.collision and BLOCKED_TILE_BIT) != BLOCKED_TILE_BIT) continue
//
//                    val actualLevel = if ((entry.terrain[1][x][z]!!.collision and BRIDGE_TILE_BIT) == BRIDGE_TILE_BIT) level - 1 else level
//
...
//                    val baseZ = entry.regionZ shl 6
//
//                    entry.locations[level][x][z].forEach {
...
//                        // TODO register object within the zone for interactions.
//                    }
//                }
//            }
//        }
...
//        add -> collisionFlagMap.add(location.x, location.z, location.level, mask)
//        else -> collisionFlagMap.remove(location.x, location.z, location.level, mask)
//    }
//
